---
name: commit-push
description: 팀 커밋 메세지 규칙(<type>: 한글 subject)에 맞게 커밋하고 원격에 푸시한다. "커밋하고 푸시해줘", "커밋 후 푸시", "commit and push", "커밋해줘" 처럼 커밋/푸시를 요청할 때 사용한다. 커밋 메세지만 작성하거나 규칙을 물어볼 때도 이 규칙을 따른다.
---
